...
public class MiClienteRMI2 extends JFrame implements ActionListener{
    ...
    public static void main(String[] args) {
         ...
         MiClienteRMI2 MiClienteRMI2 = new MiClienteRMI2();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Registry rmi;
        try {
            rmi = LocateRegistry.getRegistry("192.168.0.102",1234);
            ...
            Logger.getLogger(MiClienteRMI2.class.getName()).log(Level.SEVERE, null, ex);
